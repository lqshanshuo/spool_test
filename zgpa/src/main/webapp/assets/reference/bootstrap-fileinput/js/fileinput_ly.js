...
(function (factory) {
    ...
    tMain1 = '{preview}\n' +
        ...
        '</div>';
    tMain2 = '{preview}\n<div class="kv-upload-progress hide"></div>\n{remove}\n{cancel}\n{upload}\n{browse}\n';
    tPreview = '<div class="file-preview {class}" style="height:200px">\n' +
        '    {close}' +
        '    <div class="{dropClass}">\n' +
    ...
    //     '    {progress} {actions}\n' +
    //     '</div>';
    tFooter = '<div class="file-thumbnail-footer" style="width: 100px;">\n' +
        '    <div class="file-footer-caption" title=""></div>\n' +
        '    {progress} {actions}\n' +
        '</div>';
    ...
    defaultPreviewSettings = {
        ...
        audio: {width: "213px", height: "80px"},
        flash: {width: "213px", height: "120px"},
